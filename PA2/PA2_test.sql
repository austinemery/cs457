...
insert into table values(2,	'PowerGizmo', 	29.99);
insert into table values(3,	'SingleTouch', 	149.99);
insert into table values(4,	'MultiTouch', 	199.99);
insert into table values(5,	'SuperGizmo', 	49.99);
